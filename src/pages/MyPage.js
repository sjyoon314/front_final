                    ...
                    <div style={{width:'73%',height:'100%'}}>
                        <div style={{margin:'5%', marginTop:'30px',display:'flex', flexFlow:'row nowrap', justifyContent:'space-between'}}>
                            ...
                            <div style={{display:'flex', flexFlow:'row nowrap', justifyContent:'space-around'}}>
                                ...
                                <Button onClick={()=>{setViewmode(0)}} style={{border:'solid lightgrey 1px'}}><img src='/img/VMIcon0.jpg' width='20px' alt=''></img></Button>
                                <Button onClick={()=>{setViewmode(1)}} style={{border:'solid lightgrey 1px', borderLeft:'0'}}><img src='/img/VMIcon1.jpg' width='20px' alt=''></img></Button>
                            </div>
                        </div>
                        <p style={{marginLeft:'5%', marginTop:'-25px', color:'rgb(23,162,184)', fontSize:'15px', fontWeight:'bold'}}><img src='/img/M1.jpg' width='15px' alt=''/>&nbsp;강의 시작 14일 전, 강의 종료 14일 후까지 표시됩니다.</p>
