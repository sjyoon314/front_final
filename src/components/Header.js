...
function Header(props){
    ...
    let Hcontent=<>
    <Link to='/main/mypage'><img src='/img/logo3.png' style={{width:'180px', height:'30px', marginLeft:'10px',marginTop:'18px'}} alt=''/></Link>
    </> 
    if(props.name){
    ...
    if(props.cname){
        Hcontent=<div style={{display:'flex', flexFlow:'row nowrap'}}>
            <Link to='/main/mypage'><img src='/img/header_home.png' style={{width:'50px', height:'50px', marginLeft:'5px',marginTop:'5px'}} alt=''/></Link>
    ...
    return(
        <div style={{backgroundColor:'rgb(198,16,101)', width:'100%', height:'60px', marginTop:'-8px', marginLeft:'-8px', display:'flex', flexFlow:'row nowrap', justifyContent:'space-between'}}>
            ...
            <div style={{display:'flex', flexFlow:'row nowrap'}}>
                ...
                <img src='/img/guestIcon.jpg' style={{width:'43px', height:'43px', marginLeft:'12px',marginTop:'8px'}} alt=''/>
